...
import serg.madi.bookingservice.dto.kafka_events.BookingKafkaEvent;
...
import serg.madi.bookingservice.service.util.KafkaProducerService;
...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public BookingDto createBooking(BookingRequest bookingRequest) throws JsonProcessingException {
        Booking booking = new Booking();
        fromRequest(bookingRequest, booking);
        Booking savedBooking = bookingRepository.save(booking);
        kafkaProducerService.sendBookingEvent("booking.requested", BookingKafkaEvent.fromBookingDto(savedBooking));
